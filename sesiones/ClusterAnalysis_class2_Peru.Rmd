...
7) El objeto _res.hc_ guarda la información de silueta. Cada provincia tiene su propio valor. Podemos detectar qué provincia no ha sido bien conglomerada:
...
plot(PeruProvs,col=myColors[PeruProvs$'solucionJerarquica1$cluster'], main='Densidad del Estado - usando clusters',borders=NA)
```
